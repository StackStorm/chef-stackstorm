...
describe 'stackstorm::user' do
  ...
  context "with node['stackstorm']['user']['enable_sudo'] = false" do
    let(:chef_run) do
      ChefSpec::SoloRunner.new do |node|
        node.normal['stackstorm']['user']['enable_sudo'] = false
  ...
  context "with node['stackstorm']['user']['ssh_key'] not nil" do
    let(:chef_run) do
      ChefSpec::SoloRunner.new do |node|
        node.normal['stackstorm']['user']['ssh_key'] = 'fake ssh key'
      end.converge(described_recipe)
    end
  ...
  context "with node['stackstorm']['user']['ssh_key'] and ['stackstorm']['user']['ssh_pub'] not nil" do
    let(:chef_run) do
      ChefSpec::SoloRunner.new do |node|
        node.normal['stackstorm']['user']['ssh_key'] = 'fake ssh key'
        node.normal['stackstorm']['user']['ssh_pub'] = 'fake ssh public key'
      end.converge(described_recipe)
    end
